...
TBW
"""
function plot(sol::OptimalControlSolution, args...; 
...
# specific plot
function plot(sol::OptimalControlSolution, 
...
function plot!(p::Plots.Plot{<:Plots.AbstractBackend}, sol::OptimalControlSolution, 
    xx::Union{Symbol,Tuple{Symbol,Integer}}, yy::Union{Symbol,Tuple{Symbol,Integer}}, args...; kwargs...)
...
function get(sol::OptimalControlSolution, xx::Union{Symbol,Tuple{Symbol,Integer}})
    ...
    T = sol.times
    X = sol.state_function.(T)
    U = sol.control_function.(T)
    P = sol.adjoint_function.(T)
